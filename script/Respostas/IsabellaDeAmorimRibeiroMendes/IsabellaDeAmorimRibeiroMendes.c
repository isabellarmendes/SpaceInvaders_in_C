...
void InicializaJogo(tConfigInicial config, tEstadoJogo * estadoJogo){
    estadoJogo.contaIteracao = 0;
    estadoJogo->pontuacao = 0;
    estadoJogo->direcaoFileira = 1; //começa indo para a direita
    ...
    //inicializa tiros dos aliens
    for(int i = 0; i < 3; i++){
        estadoJogo->tiroAlien[i].ativo = 0;
    }
